" Vim syntax file
" Language:	Business BASIC for Unix
" Maintainer:   Troy Farrell <troy@studyshare.net>
" Stolen From:	Allan Kelly <allan@fruitloaf.co.uk>
" Last Change:	Mon Nov 01 09:08:14 CST 2004 
...
syn keyword basicStatement BACKGROUND background Background
syn keyword basicStatement EXITTO exitto Exitto
syn keyword basicStatement RELEASE release Release
syn keyword basicStatement SETERR seterr Seterr
...
syn keyword basicFunction       FIND find Find STR str Str
...
syn match   basicLabel          "[a-zA-Z0-9_]\+:"ms=s
syn match   basicTypeSpecifier  "[a-zA-Z0-9_]\+[\$%&!#]"ms=s
...
if version >= 508 || !exists("did_basic_syntax_inits")
  ...
  hi LineNr ctermfg=LightGrey ctermbg=Black guifg=LightGrey guibg=Black
  hi Label term=bold cterm=bold gui=bold ctermfg=Green ctermbg=Black guifg=Green guibg=Black
  hi Statement term=bold cterm=bold gui=bold 
  hi Identifer term=bold ctermfg=5 guifg=SlateBlue
